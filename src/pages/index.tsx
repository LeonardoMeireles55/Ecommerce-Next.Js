...
const Home = () => {
  ...
  const primareCarouselList =
    "https://source.unsplash.com/featured/960x540?skirts,https://source.unsplash.com/featured/960x540?blouses,https://source.unsplash.com/featured/960x540?Pants,https://source.unsplash.com/featured/960x540?Scarf";
  const primareSrcList = primareCarouselList.split(",");

  const secondaryCarouselList =
    "https://source.unsplash.com/featured/960x540?rosas,https://source.unsplash.com/featured/960x540?trees,https://source.unsplash.com/featured/960x540?nature";
