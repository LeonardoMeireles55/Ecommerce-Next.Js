...
export default function ProductsCards(): JSX.Element {
        ...
        return (
            <div id='products-cards' className="flex flex-col items-center justify-center p-6 text-center hover:scale-105">
                ...
                <div className="flex space-x-4 mt-2">
                    <button className="bg-blue-700 bg-opacity-75 text-sm text-white px-2 py-1 sm:px-4 sm:py-2 rounded-md hover:bg-blue-500">
                        COMPRAR
                    </button>
                    <button className="bg-green-500 bg-opacity-75 text-sm text-white px-2 py-1 sm:px-4 sm:py-2 rounded-md hover:bg-green-400">
    ...
    return (
        <div className="py-4 mx-auto mt-1 mb-6 flex flex-col items-center justify-center text-gray-200">
            <div id="products-list" className="flex flex-col justify-center items-center sm:grid sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-12">
