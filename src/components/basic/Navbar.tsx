    ...
    return (
        <nav id="nav-bar" className="sticky top-0 z-50  bg-orange-100 text-black">
            <div className="w-full flex flex-wrap items-center justify-around gap-1 p-3 md:p-9">
                ...
                <div
                    className={`items-center justify-between w-full md:flex md:justify-center md:items-center md:mt-8 ${isMenuOpen ? "block" : "hidden"}`}
                    id="navbar-search"
                >
                    <ul
                    ...
                    >
                        ...
                        <li>
                            <Link id="cart" href="/carrinho" className="block py-1 pl-3 pr-4 ">
                                CARRINHO
                            </Link>
                        </li>
                    </ul>
