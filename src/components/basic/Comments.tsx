...
const Comment = ({ imgSrc, name, text }: CommentProps) => {
  return (
    <blockquote className="p-6 rounded-lg sm:p-8">
      ...
      <div className="max-w-screen-xl px-4 py-4 mx-auto sm:px-6 lg:px-8">
        <h2 className="text-4xl font-bold tracking-tight text-center text-gray-900 sm:text-5xl">
          <span className="flex items-center">
            ...
            <span
              id="new-collection"
              className="px-6 text-xl text-black shrink-0 md:text-4xl"
            >
              Avaliações
            </span>
            <span className="flex-1 h-px bg-black"></span>
        ...
        <div className="grid grid-cols-1 gap-4 md:mt-2 md:grid-cols-3 md:gap-8">
          <Comment
