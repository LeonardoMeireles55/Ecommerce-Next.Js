...
const ProductsCards = ({ categoryProps }: CategoryProps): JSX.Element => {
  ...
  const createProductTags = (product: Product) => {
    ...
    return (
      <div id="products-cards" key={id} className="relative p-4 md:p-6 flex flex-col items-center justify-center text-center border border-dashed border-orange-200 border-opacity-75 border-1 shadow-sm">
