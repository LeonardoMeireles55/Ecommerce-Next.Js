        ...
        return (
            <div id='products-cards' key={id} className="relative flex flex-col items-center justify-center p-2 text-center hover:scale-105">
                ...
                <button
                    ...
                    className="absolute bottom-1 right-3 mb-2 bg-yellow-400 bg-opacity-50 text-black px-1 py-1 md:px-1 md:py-1 rounded-full hover:bg-yellow-100 focus:bg-yellow-400"
                >
    ...
    return (
        <div>
            <span className='flex justify-center items-center text-center'>
                <h1 className='mt-6 md:text-lg text-base underline'>BEST SELLERS</h1>
            </span>
