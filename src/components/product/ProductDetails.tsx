          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex mb-4">
              <span className="flex items-center">
                ...
                <span className="text-gray-600 ml-3">{productsDescription[0].stars}</span>
              </span>
              <span className="flex ml-3 pl-3 py-2 border-l-2 border-gray-200">
                ...
                <a className="ml-2 text-gray-500">
                  <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                    <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 
                    013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z">
                    </path>
                  </svg>
                </a>
                <a className="ml-2 text-gray-500">
                  <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
                    <path d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.
                    9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z">
                    </path>
                  </svg>
                </a>
              </span>
            ...
            <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-700 border-opacity-25 mb-5">
              ...
              <div className="flex ml-6 items-center">
                ...
                <div className="relative">
                  <select className="bg-orange-100 rounded border appearance-none
                   border-gray-400 py-2 focus:outline-none
                   focus:border-yellow-500 text-base pl-3 pr-10">
                    <option>SM</option>
                    <option>M</option>
                    <option>L</option>
                    <option>XL</option>
                  </select>
                  <span className="absolute right-0 top-0 h-full w-10 text-center
                   text-gray-600 pointer-events-none flex items-center justify-center">
            ...
            <div className="flex">
              <span className="font-medium text-2xl text-gray-900">${discountedPrice}</span>
              <button onClick={() => addToCart(productsDescription[0])} className="rounded-full flex ml-auto text-white
               bg-orange-300 bg-opacity-85 border-0 py-2 px-6 focus:outline-none hover:bg-orange-200">
                <svg width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M8 11.01V11M16 11.01V11M8 8V7C8 5.93913 8.42143 4.92172 9.17157 4.17157C9.92172 3.42143
                     10.9391 3 12 3C13.0609 3 14.0783 3.42143 14.8284 4.17157C15.5786 4.92172 16 5.93913 16 
                     7V8M8 8H6.84027C5.80009 8 4.93356 8.79732 4.84718 9.83391L4.18051 17.8339C4.08334 18.9999 5.
                     00352 20 6.1736 20H17.8264C18.9965 20 19.9167 18.9999 19.8195 17.8339L19.1528 9.83391C19.0664 
                     8.79732 18.1999 8 17.1597 8H16M8 8H16"
                    stroke="#000000"
                    strokeWidth="1.0"
                    strokeLinecap="round"
